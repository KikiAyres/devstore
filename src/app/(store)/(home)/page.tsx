...
export default async function Home() {
  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6 mt-5">
      <Link
        href={`/product/${highLightedProduct.slug}`}
        className="group relative col-span-6 row-span-6 rounded-lg bg-zinc-100/30 overflow-hidden flex justify-center"
      >
        <Image
          id="cd"
      ...
      {otherProducts.map((product) => {
        return (
          <Link
            ...
            className="group relative flex-col col-span-3 row-span-3 rounded-lg bg-zinc-100/30 overflow-hidden flex justify-center items-end"
          >
            <Image
              src={product.image}
              className="group-hover:scale-105 transition-transform duration-500"
